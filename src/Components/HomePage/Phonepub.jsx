...
<div className="w-full text-[#0B0C38] bg-[#FBEDEC] py-16 px-4 ">
    <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
          < img className="w-[500px] mx-auto my-4 hover:scale-105 duration-300" src={Phone} alt="/" />
    <div className="flex flex-col justify-center"> 
      ...
      <Link > <button className="bg-[#FB9B90] w-[200px] rounded-md font-semibold my-6 mx-auto md:mx-0 py-3 text-[#191A43] ring-2 ring-[#ED6361] hover:scale-105 duration-100"
      > Rechercher
      </button>
      </Link>
    </div>
